...
export function personNeedsVerification(person: PersonVerificationFields): boolean {
...
export function personVerificationSummary(person: PersonVerificationFields): string {
  const parts: string[] = [];
